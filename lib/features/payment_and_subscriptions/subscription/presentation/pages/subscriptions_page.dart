                  ...
                  child: state.status == Status.loading
                      ...
                      : ListView(
                          ...
                          children: [
                            ...
                            if (state.accountSubscription != null)
                              SubscriptionCard(
                                subscription: state.accountSubscription!,
                              ),
                            ...
                            AvailablePlansSection(
                              currentPlanType:
                                  state.accountSubscription?.planType ?? '',
                            ),
                          ],
                        ),
                ),
...
class AvailablePlansSection extends StatelessWidget {
  final String currentPlanType;

  const AvailablePlansSection({super.key, required this.currentPlanType});
